...
public class main {
   public static void main(String[]args) {
	  ...
	  //ArrayList to store instance variables
		      ...
		      if (d > 20) {
			    count++;
		          ...
		          invalidPower(choose3); 
		            ...
		            //Variable that stores the distance moved
		            ...
		            //Line that print out the distance to the hole
		            printDistance(d,progress2);
    ...
    if(choose == 2) {
         ...
         public static void printScore(int score, int temppar) {
        	 if(score - temppar < 0) {
		    	  System.out.println("Your score after the hole is: " + (score - temppar) +" under");
		    	        ...
		    	        System.out.println("Your score after the hole is: " + (score - temppar) + " over");
		                }  
         }
         ...
         public static void makeHole(int d, int progress, int temp) {
        	 if(d*3 <= 1) {
			       System.out.println("It's in the hole!");
			         if(progress <= temp) {
				       System.out.println("You made par on this hole");
