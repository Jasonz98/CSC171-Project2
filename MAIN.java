	      ...
	      if (d > 20) {
	        ...
	        System.out.println("You hit " + (int)temp6 + " yards." + "\n");	  
		        ...
		        if(d*3 <= 1.0) {
				     ...
				     }else if (progress<temp3){
					   System.out.println("You score on this hole is "+(temp3-progress)+"under. ");
				   }
				     else {
				    	 System.out.println("You score on this hole is "+(progress-temp3)+"over. ");
				     }
			
				       score = score + temp3-count;   
					     if (score>0) {
					     System.out.println("Your score after the hole is: " +score+" under. ");
					     }
					     else if (score==0) {
					    	 System.out.println("Your score after this hole is: Par;");
					     }
					     else if (score>0) {
						     System.out.println("Your score after the hole is: " +score+" over. ");
						     }
	        ...
	        if(d >= 20) {
		       System.out.println("[Shot " + (progress2 )+ "]. " +  (int)d + " yards to the hole." );
	        }else if (d < 20) {
		       System.out.println("Shot " + (progress2 )+ ". " +  (int)(d*3) + " feet to the hole.");
	        }
